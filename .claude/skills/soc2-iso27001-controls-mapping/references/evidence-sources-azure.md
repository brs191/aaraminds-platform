...
Per-source reference for pulling audit evidence in this stack. For each: what it contains, how long it's retained, how to query it, and what audit artifact to produce.
...
Evidence sources, retention defaults, KQL table names, and Defender feature names change. Re-verify quarterly per the freshness cadence in `../../../../validation/governance/freshness-cadence.md` and the Microsoft Learn docs links in `../../mcp-go-server-building/references/ecosystem-facts.md`.
