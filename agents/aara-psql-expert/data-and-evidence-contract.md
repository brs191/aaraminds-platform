# Data & Evidence Contract — aara-psql-expert
...
|---|---|---|---|
| schema-definitions | engagement-provided DDL and migration repository | client-confidential | read-only [TODO confirm] |
| postgresql-knowledge | PostgreSQL official documentation and internal SQL standards | public | read-only [TODO confirm] |
| sql-drafts | agent blueprint repository | client-confidential | read-only [TODO confirm] |
